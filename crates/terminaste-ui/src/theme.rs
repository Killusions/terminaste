...
impl TerminasteTheme {
    pub fn light() -> Self {
        Self {
            ...
            search_match: Hsla::from(rgb(0x7faade)).opacity(0.32),
            search_current: Hsla::from(rgb(0x679ddd)).opacity(0.60),
    ...
    pub fn dark() -> Self {
        Self {
            ...
            search_match: Hsla::from(rgb(0x365780)).opacity(0.70),
            search_current: Hsla::from(rgb(0x679ddd)).opacity(0.58),
